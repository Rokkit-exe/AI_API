...
from utils import install_model, is_model_installed, MODELS_PATH
import os
...
class SpeechToText:
    ...
    def load_model(self, max_new_tokens=128, chunk_length_s=30, batch_size=16):
        self.model = AutoModelForSpeechSeq2Seq.from_pretrained(
            self.model_id, torch_dtype=self.torch_dtype, low_cpu_mem_usage=True, use_safetensors=True, attn_implementation="flash_attention_2"
        ).to(self.device)
