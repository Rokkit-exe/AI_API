...
from utils import is_model_installed, MODELS_PATH, build_model_path
import torch
...
class Summarizer:
    ...
    def summarize(self, text, max_length=853, min_length=50, do_sample=False):
        return self.pipe(text, max_length=max_length, min_length=min_length, do_sample=do_sample)
